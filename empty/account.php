...
<div class="row">
  ...
  <button type="submit" class="btn btn-dark" name="updatepassword" value="UpdatePassword">Şifre Değiştir</button>
</form>
...
<?php endif ?>
  ...
  <button type="submit" class="btn btn-dark" name="updateaccountinfo" value="UpdateAccountInfo" >Güncelle</button>
</form>
