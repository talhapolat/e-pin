...
if (isset($_SESSION["useremail"])) {  
  ...
  if ($userNum > 0) { ?>
    <a style="float: left; font-size: 20px; text-transform: uppercase;"><?= $user["name"] ?></a>
  ...
  <ul class="list-group list-group-flush" id="userpanellist">
    <li class="list-group-item block1-txt userwidget" id="list1"><i class="fas fa-user m-r-2" style="font-size: 17px"> </i> Hesap Bilgilerim</li>
    <li class="list-group-item block1-txt userwidget" id="list2"><i class="fab fa-shopify m-r-2" style="font-size: 17px"> </i> Siparişlerim</li>
    <li class="list-group-item block1-txt userwidget" id="list3"><i class="fas fa-university m-r-2" style="font-size: 16px"> </i> Ödeme Bildirimi</li>
    <li class="list-group-item block1-txt userwidget" id="list4"><i class="fas fa-plus-circle m-r-2" style="font-size: 17px"></i> Bakiye Yükle</li>
    <li class="list-group-item block1-txt userwidget" id="list5"><i class="fas fa-sign-out-alt m-r-2" style="font-size: 17px"></i> Çıkış</li>
  </ul>
</div>
...
<?php  
  ...
  <button class="btn btn-dark js-show-modal1" style="color: #f9f9f9">KAYIT OL</button>
</form>
  ...
  <script type="text/javascript">
    ...
    document.getElementById("userpanellist").addEventListener("click",function(e) {
        ...
        if(e.target && e.target.nodeName == "LI" && e.target.id == "list1") {
            ...
            window.location.href = "/addbalancebank";
