...
<form action="app/func.php" method="POST" class="mb-3">
  <div class="mb-3 mt-3">
    ...
    <input type="number" min="1" max="5000" placeholder="Tutar" class="form-control" id="InputBalance" name="inputBalance" required="required">
  </div>
  <button type="submit" class="btn btn-dark" name="addbalancecart" value="AddBalanceCart">Kredi Kartı / Banka Kartı</button>
   <button type="submit" class="btn btn-dark" name="addbalancehavale" value="AddBalanceHavale">Havale</button>
</form>
	...
	<div class="col-md-3 justify-content-center desktopslider" style="background-color: #f7f7f7; border: 2px solid #f7f7f7;padding-top: 20px">
