			...
			<div class="p-b-10">
				<div class="row">
					<div class="col-md-7">
						<a class="ltext-102 cl5" style="color: black">
            ...
            <button class="btn btn-warning m-b-17 js-show-modal2" style="font-family: Poppins-Medium">Transfer Şartları</button>            
            <?php endif ?>
            <?php if ($category["description3"] != null): ?>
            <button class="btn btn-danger m-b-17 js-show-modal3" style="font-family: Poppins-Medium">Ban Riski</button>        
            <?php endif ?>
					</div>
				</div>
        ...
        <?php if ($category["custompacket"] == 1): ?>
          ...
          <div class="block1 wrap-pic-w" style="border-bottom: 0px!important">
            ...
            <a href="custom/<?= $category["slug"] ?>" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
          
              <div class="block1-txt-child3 flex-col-l">
                <span class="block1-name ltext-110 trans-04 p-b-8" style="color: white">
                  <?= $category["title"] ?>
                </span>
          ...
          <a class="block1text" style="font-family: Poppins-Bold;">PAKET OLUŞTUR</a>
          <a class="block1text" style="float: right; font-family: Poppins-Bold;"> </a>
          </div>
        </div>         
        <?php endif ?>
				...
				<?php 
		      $productQuery = $dbConnect->prepare("SELECT * FROM product WHERE statu = 1 AND category_id = ? AND deleted = 0 ORDER BY price");
          ...
          foreach ($products as $key => $product) { ?>
            ...
            <a href="p/<?= $product["slug"] ?>" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
					...
					<div class="block1 wrap-pic-w bg-dark p-2" style="border-top: 0px; color: #f9f9f9; ">
					<a class="block1text" style="font-family: Poppins-Bold;"><?= $product["title"] ?></a>
					<a class="block1text" style="float: right; font-family: Poppins-Bold;"> <?= $product["price"] ?> ₺</a>
					</div>
				</div>
