...
$productQuery = $dbConnect->prepare("SELECT * FROM product WHERE statu = 1 and deleted = 0 and slug = ?");
$productQuery->execute([$prdct]);
...
<body class="animsition">
	...
	<div class="container">
		<div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg">
			...
			<a href="category/<?= $category["slug"]; ?>" class="stext-109 cl8 hov-cl1 trans-04">
				<?= $category["title"]; ?>
				<i class="fa fa-angle-right m-l-9 m-r-10" aria-hidden="true"></i>
			</a>
			...
			<div class="row">
				...
				<div class="col-md-6 col-lg-5 p-b-30">
					<div class="p-r-50 p-t-5 p-lr-0-lg">
						...
						<div class="p-t-33">
							<form action="app/func.php" method="POST" id="product_form">
										...
										<div class="size-204 ">
											<div class="rs1-select2  bg0">
												<?php if (isset($_SESSION["useremail"])) { ?>
													<input type="text" class="form-control" name="in_name" id="exampleFormControlInput1" placeholder="Adınızı ve soyadınızı yazınız" value="<?= $_SESSION["username"] ?>" required="required">
													<?php
												} else { ?>
								...
								<?php if ($category["in_phone"] == 1) { ?>
									<div class="flex-w flex-r-m p-b-10">
										...
										<div class="size-204">
											<div class="rs1-select2 bg0">
												<?php if (isset($_SESSION["useremail"])) { ?>
													<input type="text" class="form-control" name="in_phone" id="exampleFormControlInput1" placeholder="Telefon numaranızı yazınız" value="<?= $_SESSION["userphone"] ?>" required="required">
													<?php
												} else { ?>
										...
										<div class="container">
											<div class="row"> 
												...
												<?php if ($product["stock"] < 1) { ?>
													<button type="button" class="flex-c-m stext-101 cl0 size-101 bg-dark bor1 hov-btn1 ml-5  trans-04">
														STOKTA YOK
													</button>
													<?php
												} else {?>
													...
													<?php if (isset($_SESSION["useremail"])) { ?>
														...
														<button type="button" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 ml-5 trans-04 js-addwish-detail" style="color: white">
															SİPARİŞİ OLUŞTUR
														</button>
