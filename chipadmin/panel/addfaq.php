...
<html>
                ...
                <div class="col-lg-12 p-3">
                  <div class="recent-updates card p-3">
                    ...
                    <div class="card-header">
                      <h3 class="h4">Yeni S.S.S. Ekle</h3>
                    </div>
  ...
  <div class="mb-3">
    ...
    <textarea type="text" class="form-control" rows="7" id="InputContent" name="content" required=""> </textarea>
  </div> 

  <button type="submit" class="btn btn-primary" name="newfaq">Kaydet</button>
</form>
