                  ...
                  <div class="card-body " style="overflow: auto;">
                    ...
                    <table id="example" class="display compact" style="width:100%">
                      ...
                      <tbody>
                        ...
                        <?php 
                        $orderQuery = $dbConnect->prepare("SELECT * FROM orders WHERE deleted = 0 ORDER BY id DESC");
                        $orderQuery->execute();
                        ...
                        <?php foreach ($orders as $key => $order): ?>
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <a href="/chipadmin/panel/app/func.php?orderdelete=<?= $order["id"] ?>" class="btn btn-danger" style="color: white; text-decoration: none"><i class="fa fa-trash"></i> SİL</a>
                            </td>
                          </tr>                
