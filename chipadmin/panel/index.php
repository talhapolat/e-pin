...
$userQuery = $dbConnect->prepare("SELECT * FROM users WHERE deleted = 0 and statu = 1");
$userQuery->execute();
              ...
              <div class="row">
                ...
                <div class="statistics col-lg-3 col-12">
                  <div class="statistic d-flex align-items-center bg-white has-shadow">
                    ...
                    <div class="text"><strong><?= $usersNum ?></strong><br><small>Üye Sayısı</small></div>
                  </div>
                  <div class="statistic d-flex align-items-center bg-white has-shadow">
                  ...
                  <div class="statistic d-flex align-items-center bg-white has-shadow">
                    ...
                    <div class="text"><strong><?= number_format($total["total"], 2) ?> ₺</strong><br><small>Sipariş Toplamı</small></div>
                  </div>
                  <div class="statistic d-flex align-items-center bg-white has-shadow">
                    <div class="icon bg-green"><i class="fa fa-money"></i></div>
                    <div class="text"><strong><?= number_format($totalB["totalB"], 2) ?>₺</strong><br><small>Yüklenen Bakiye Toplamı</small></div>
                  </div>                  
