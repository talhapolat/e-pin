...
<html>
                ...
                <div class="col-lg-12 p-3">
                  <div class="recent-updates card p-3">
                    ...
                    <div class="card-header">
                      <h3 class="h4">Yeni Haber Ekle</h3>
                    </div>
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="InputText" name="text" required="required" >
  </div> 

  <div class="mb-3">
    <label for="InputTopic" class="form-label">Konu</label>
    <input type="text" class="form-control" id="InputTopic" name="topic" required="required" >
  </div>

  <button type="submit" class="btn btn-primary" name="newblog">Kaydet</button>
</form>
