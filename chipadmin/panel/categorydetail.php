...
<html>
  ...
  <div class="mb-3">
    <label for="InputTitle" class="form-label">Alt Birim Simgesi</label>
    <input type="text" class="form-control" id="InputBirim1" name="birim1" value="<?= $category["birim1"] ?>" required="required" >
  </div>

  <div class="mb-3">
    <label for="InputTitle" class="form-label">Üst Birim Simgesi <small>(4 BASAMAK VE ÜSTÜ MİKTARLAR İÇİN GÖSTERİLECEK BİRİM SİMGESİ. <b>örn: 5000B yerine 5T</b>)</small></label>
  ...
  <div class="mb-3">
    ...
    <div class="mb-3">
        <label class="form-check-label" for="flexSwitchCheckDefault">ÖZEL PAKET OLUŞTURMA</label> <br>
