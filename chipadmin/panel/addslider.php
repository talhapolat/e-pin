              ...
              <div class="col-lg-12 p-3">
                <div class="recent-updates card p-3">
                  ...
                  <div class="card-header">
                    <h3 class="h4">Yeni Slider Ekle</h3>
                  </div>
                  ...
                  <div class="card-body ">
                    ...
                    <form action="/chipadmin/panel/app/func.php" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="mb-3">
                        <label for="InputTitle" class="form-label">Slider Başlık</label>
                        <input type="text" class="form-control" id="InputTitle" name="title" placeholder="Başlık" required="required" >
                      </div>
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="InputLink" name="link" placeholder="Link vermek istiyorsanız yazınız" >
                      </div>

                      <button type="submit" class="btn btn-primary" name="newslider">Kaydet</button>
                    </form>
