    ...
    <div class="page">
      ...
      <div class="page-content d-flex align-items-stretch"> 
                ...
                <div class="col-lg-12 p-3">
                  <div class="recent-updates card p-3">
                    ...
                    <div class="card-header">
                      <h3 class="h4">Ödeme Bekleyen Bakiye Yüklemeleri</h3>
                    </div>
        ...
        <tbody>
            ...
            <?php 
                $orderQuery = $dbConnect->prepare("SELECT * FROM orders_balance WHERE deleted = 0 and statu = 0 ORDER BY id DESC");
                $orderQuery->execute();
            ...
            <tr>
                ...
                <td> 
                    <?php  
                      ...
                      case 1:
                          ?>
                          <a href="/chipadmin/panel/app/func.php?orderBstatuchange=<?= $order["id"] ?>&statu=2" class="btn btn-danger">Sipariş Tamamlandı</a> 
                          <?php
                          break;
                      case 2:
                          ?>
                          <a href="/chipadmin/panel/app/func.php?orderBstatuchange=<?= $order["id"] ?>&statu=0" class="btn btn-success">Sipariş İptal</a> 
                          <?php
                          break;    
                      }
                    ?>
